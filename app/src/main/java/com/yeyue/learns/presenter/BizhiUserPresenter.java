...
@ActivityScope
public class BizhiUserPresenter extends BasePresenter<BizhiUserContract.Model, BizhiUserContract.View> {
    ...
    @Inject
    public BizhiUserPresenter(BizhiUserContract.Model model, BizhiUserContract.View rootView
    ...
    public void getUser(String uId) {
        mModel.getUser(uId)
                ...
                .subscribe(new ErrorHandleSubscriber<UserDetail>(mErrorHandler) {
                    @Override
