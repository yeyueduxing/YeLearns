...
public class DropDownMenu extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        View body = findViewById(R.id.ye_drop_content);
        removeView(body);
        containerView.addView(body, 0);
    }
    ...
    public void closeMenu() {
        if (current_tab_position != -1) {
            ...
            popupMenuViews.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.ye_dd_menu_out));
            maskView.setVisibility(GONE);
            maskView.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.ye_dd_mask_out));
            ...
            if (target == tabMenuView.getChildAt(i)) {
                if (current_tab_position == i) {
                    ...
                    if (current_tab_position == -1) {
                        ...
                        popupMenuViews.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.ye_dd_menu_in));
                        maskView.setVisibility(VISIBLE);
                        maskView.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.ye_dd_mask_in));
