 ...
 * @param <P>
 */
public abstract class YeBottomBarActivity<P extends IPresenter> extends BaseUiActivity<P> implements BottomNavigationView.OnNavigationItemSelectedListener {
