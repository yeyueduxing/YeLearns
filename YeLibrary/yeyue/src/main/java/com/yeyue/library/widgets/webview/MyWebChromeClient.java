...
public class MyWebChromeClient extends WebChromeClient {
    ...
    private YeWebActivity mActivity;
    private YeWebPageView mIWebPageView;
    private View mXCustomView;
    private CustomViewCallback mXCustomViewCallback;

    public MyWebChromeClient(YeWebPageView mIWebPageView) {
        this.mIWebPageView = mIWebPageView;
        this.mActivity = (YeWebActivity) mIWebPageView;
    }
    ...
    public View getVideoLoadingProgressView() {
        if (mXProgressVideo == null) {
            ...
            mXProgressVideo = inflater.inflate(R.layout.yeyue_video_loading_progress, null);
        }
